...
data class LimitMilho(
    ...
    @ColumnInfo(name = "brokenUpLim")
    val brokenUpLim: Float,

    @ColumnInfo(name = "ardidoUpLim")
    val ardidoUpLim: Float,

    @ColumnInfo(name = "mofadoUpLim")
    val mofadoUpLim: Float,

    @ColumnInfo(name = "carunchadoUpLim")
    val carunchadoUpLim: Float,
