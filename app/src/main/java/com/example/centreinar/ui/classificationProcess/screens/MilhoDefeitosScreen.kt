...
fun MilhoDefeitosScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                value = ardidos,
                onValueChange = { ardidos = it },
                label = { Text("Ardidos (%)") })
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedTextField(
                value = queimados,
                onValueChange = { queimados = it },
                label = { Text("Queimados (%)") })
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedTextField(
                value = mofados,
                onValueChange = { mofados = it },
                label = { Text("Mofados (%)") })
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedTextField(
                value = fermentados,
                onValueChange = { fermentados = it },
                label = { Text("Fermentados (%)") })
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedTextField(
                value = germinados,
                onValueChange = { germinados = it },
                label = { Text("Germinados (%)") })
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedTextField(
                value = imaturos,
                onValueChange = { imaturos = it },
                label = { Text("Imaturos (%)") })
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedTextField(
                value = chochos,
                onValueChange = { chochos = it },
                label = { Text("Chochos (%)") })
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedTextField(
                value = danificados,
                onValueChange = { danificados = it },
                label = { Text("Danificados (%)") })
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedTextField(
                value = esverdeados,
                onValueChange = { esverdeados = it },
                label = { Text("Esverdeados (%)") })
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedTextField(
                value = partidos,
                onValueChange = { partidos = it },
                label = { Text("Partidos/Quebrados (%)") })
