...
fun MilhoDiscountInputScreen(
    ...
    Column(
        ...
        OutlinedTextField(
            value = lotWeight,
            onValueChange = { lotWeight = sanitize(it) },
            label = { Text("Peso do lote (kg)") },
            modifier = Modifier
                .fillMaxWidth()
                .padding(vertical = 8.dp)
                .focusRequester(lotFocus),
        ...
        OutlinedTextField(
            value = priceBySack,
            onValueChange = { priceBySack = sanitize(it) },
            label = { Text("Preço por saca (60kg)") },
            modifier = Modifier
                .fillMaxWidth()
                .padding(vertical = 8.dp)
        ...
        OutlinedTextField(
            value = impurities,
            onValueChange = { impurities = sanitize(it) },
            label = { Text("Impurezas (%)") },
            modifier = Modifier
                .fillMaxWidth()
                .padding(vertical = 8.dp)
        ...
        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            OutlinedTextField(
                value = broken,
                onValueChange = { broken = sanitize(it) },
                label = { Text("Partidos (%)") },
                modifier = Modifier.weight(1f)
            )
            OutlinedTextField(
                value = ardidos,
                onValueChange = { ardidos = sanitize(it) },
                label = { Text("Ardidos (%)") },
                modifier = Modifier.weight(1f)
            )
        }
        ...
        OutlinedTextField(
            value = mofados,
            onValueChange = { mofados = sanitize(it) },
            label = { Text("Mofados (%)") },
            modifier = Modifier
                .fillMaxWidth()
                .padding(vertical = 8.dp)
        ...
        OutlinedTextField(
            value = carunchado,
            onValueChange = { carunchado = sanitize(it) },
            label = { Text("Carunchado (%)") },
            modifier = Modifier
                .fillMaxWidth()
                .padding(vertical = 8.dp)
        )
        ...
        if (doesTechnicalLoss) {
            OutlinedTextField(
                value = daysOfStorage,
                onValueChange = { daysOfStorage = sanitize(it) },
                label = { Text("Dias de armazenamento") },
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(vertical = 8.dp)
            )
        ...
        if (doesDeduction) {
            OutlinedTextField(
                ...
                onValueChange = { deductionValue = sanitize(it) },
                label = { Text("Valor do deságio (%)") },
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(vertical = 8.dp)
            )
